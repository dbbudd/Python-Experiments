...
#warning
#The plug-in is very buggy and often crashes it. The spinning wheel of death occurs
        ...
        while (True):
            ...
            for i in range(0, self.my_joystick.get_numaxes()):
                if (self.my_joystick.get_axis(i)):
                    print "X:", round(90*self.my_joystick.get_axis(2),0),"Y:", round(-90*self.my_joystick.get_axis(3),0)
